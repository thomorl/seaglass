...
public class WindowsKeybindingsTest {

    @Test
    public void testEquality() {
        final Object[] expectedDefaults = getExpectedDefaults();
        // Verify that the new keybindings implementation
        // produces the same results as the internal one
        AssertUtils.assertKeybindingsEquals(
                expectedDefaults,
                KeybindingsLoader.loadKeybindings("Windows.kb")
        );
    }

    private Object[] getExpectedDefaults() {
        final Object fieldInputMap = new UIDefaults.LazyInputMap(new Object[]{
        ...
        final Object passwordInputMap = new UIDefaults.LazyInputMap(new Object[]{
                "control C", DefaultEditorKit.copyAction,
                "control V", DefaultEditorKit.pasteAction,
                "control X", DefaultEditorKit.cutAction,
                "COPY", DefaultEditorKit.copyAction,
